...
class teymThree : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_teym_three)
        ...
        docRef.get().addOnSuccessListener { document ->
            if (document != null) {
                val yourText = document.getString("temyThree")
        ...
        val fileRef = storageRef.child("/theory/logical expression.pdf")
