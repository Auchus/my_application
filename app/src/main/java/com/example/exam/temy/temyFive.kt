...
class temyFive : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_temy_five)
        ...
        docRef.get().addOnSuccessListener { document ->
            if (document != null) {
                val yourText = document.getString("temyFive")
        ...
        val fileRef = storageRef.child("/theory/algorithm.pdf")
