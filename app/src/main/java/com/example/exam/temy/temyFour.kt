...
class temyFour : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_temy_four)
        ...
        docRef.get().addOnSuccessListener { document ->
            if (document != null) {
                val yourText = document.getString("temyFour")
        ...
        val fileRef = storageRef.child("/theory/shortest route.pdf")
