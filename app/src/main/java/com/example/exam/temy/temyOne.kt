...
class temyOne : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_temy_one)
        ...
        docRef.get().addOnSuccessListener { document ->
            if (document != null) {
                val yourText = document.getString("temyOne")
        ...
        val fileRef = storageRef.child("/theory/information volume.pdf")
